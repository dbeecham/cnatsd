...
CFLAGS         = -I. -Iinclude -Iinc -Isrc -Wall -Wextra \
...
cnatsd: cnatsd.o cnatsd_client.o cnatsd_worker_task.o cnatsd_accept_task.o
...
test_driver: test_driver.o test_ws_parser.o ws_parser.o \
             http_parser.o aat_parser.o munit.o
...
install: $(DESTDIR)$(PREFIX)/bin/cnatsd $(DESTDIR)$(PREFIX)/include/cnatsd.h
...
distclean: clean
	rm -f *.so cnatsd compile_commands.json cscope.files cscope*.out
